...
experiments = {
    ...
    "experiment_train_blade_2": {
        "class_list": ["wifi","anom_wifi"],
        "train_dir": ["/data/s3_gamutrf/gamutrf-anom-wifi2/collect/wifi_tx/blade/", "/data/s3_gamutrf/gamutrf-anom-wifi2/collect/wifi_tx_mod/blade/"],
        "val_dir": ["/data/s3_gamutrf/gamutrf-anom-wifi2/collect/wifi_tx/ettus/", "/data/s3_gamutrf/gamutrf-anom-wifi2/collect/wifi_tx_mod/ettus/"],
        "iq_epochs": 40,
        "spec_epochs": 70,
        "spec_batch_size": -1,
        "spec_skip_export": True, # USE WITH CAUTION (but speeds up large directories significantly): skip after first run if using separate train/val directories 
    ...
    "experiment_train_ettus_2": {
        "class_list": ["wifi","anom_wifi"],
        "train_dir": ["/data/s3_gamutrf/gamutrf-anom-wifi2/collect/wifi_tx/ettus/", "/data/s3_gamutrf/gamutrf-anom-wifi2/collect/wifi_tx_mod/ettus/"],
        "val_dir": ["/data/s3_gamutrf/gamutrf-anom-wifi2/collect/wifi_tx/blade/", "/data/s3_gamutrf/gamutrf-anom-wifi2/collect/wifi_tx_mod/blade/"],
        "iq_epochs": 40,
        "spec_epochs": 70,
        "spec_batch_size": -1,
        "spec_skip_export": True, # USE WITH CAUTION (but speeds up large directories significantly): skip after first run if using separate train/val directories 
    ...
    "experiment_train_blade_1": {
        ...
        "val_dir": ["/data/s3_gamutrf/gamutrf-nz-anon-wifi", "/data/s3_gamutrf/gamutrf-nz-nonanon-wifi"],
        "iq_epochs": 40,
        "spec_epochs": 70,
        "spec_batch_size": -1,
        "spec_skip_export": True, # USE WITH CAUTION (but speeds up large directories significantly): skip after first run if using separate train/val directories 
    ...
    "experiment_train_ettus_1": {
        "class_list": ["wifi","anom_wifi"],
        "train_dir": ["/data/s3_gamutrf/gamutrf-nz-anon-wifi", "/data/s3_gamutrf/gamutrf-nz-nonanon-wifi"],
...
if __name__ == "__main__":
    ...
    for experiment_name in experiments_to_run:
        ...
        try:
            exp = Experiment(experiment_name=experiment_name, **experiments[experiment_name])
